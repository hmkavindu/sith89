    ...
    "causes": [
      {
        ...
        "reason": "කැමති දෙයට අශා කිරීම",
        "conditions": ["අනිත්‍ය ස්වභාවය නොදැනීම", "අනිත්‍ය දෙයක් නිත්‍යයි සිතීම", "ඒ දේ ලැබීමෙන් හිතට තෘප්තියක් ලැබේ යැයි සිතීම"],
        "remedies": ["අනිත්ය දුක්ඛ අනාත්ම ලෙස මෙනෙහි කිරීම", "දානය සහ සීලය පැවැත්වීම"]
      }
    ],
    "dhammaQuotes": [...],
    "studyMaterials": [...]
